...
class TINI_I18n {
    ...
    loadTranslations() {
        ...
        this.translations.vi = {
            ...
            mysql_connected: "MySQL Đã Kết Nối",
            redis_connected: "Redis Đã Kết Nối",
            connection_healthy: "Kết Nối Tốt",
            connection_failed: "Kết Nối Thất Bại",
            checking_connection: "Đang Kiểm Tra Kết Nối",
            database_health: "Sức Khỏe Cơ Sở Dữ Liệu",
        ...
        this.translations.zh = {
            ...
            mysql_connected: "MySQL已连接",
            redis_connected: "Redis已连接",
            connection_healthy: "连接正常",
        ...
        this.translations.hi = {
            ...
            environment_config: "पर्यावरण कॉन्फ़िगरेशन",
            mysql_connected: "MySQL कनेक्ट हो गया",
            redis_connected: "Redis कनेक्ट हो गया",
            connection_healthy: "कनेक्शन स्वस्थ",
            connection_failed: "कनेक्शन विफल",
            checking_connection: "कनेक्शन जांच रहे हैं",
            database_health: "डेटाबेस स्वास्थ्य",
        ...
        this.translations.ko = {
            ...
            mysql_connected: "MySQL 연결됨",
            redis_connected: "Redis 연결됨",
            connection_healthy: "연결 정상",
            connection_failed: "연결 실패",
            checking_connection: "연결 확인 중",
            database_health: "데이터베이스 상태",
